...
public class BGMManager {
    static boolean useAble = false;
    static {
        try {
            Class.forName("com.sun.media.jfxmedia.AudioClip");
            useAble = true;
        }
        catch (Exception ignored) {
            PopupMessage.createMessage(Launcher.languageManager.get("ui.bgm.lib.exc"), PopupMessage.MessageTypes.LABEL, event -> {}, Color.DARKRED);
        }
    }
