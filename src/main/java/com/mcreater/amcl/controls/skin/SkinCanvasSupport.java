...
public abstract class SkinCanvasSupport implements Consumer<SkinView> {
                ...
                if (e.isAccepted()) {
                    ...
                    Platform.runLater(() -> {
                        try {
                            ...
                            t.updateSkin(new Image(input), skin.getName().contains("[alex]"), null);
