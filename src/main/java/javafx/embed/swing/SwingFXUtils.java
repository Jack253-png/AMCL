...
public class SwingFXUtils {
    ...
    public static WritableImage toFXImage(BufferedImage var0, WritableImage var1) {
        ...
        if (var1 != null) {
            ...
            if (var10 >= var2 && var12 >= var3) {
                if (var2 < var10 || var3 < var12) {
                    ...
                    if (var2 < var10) {
                        var7.setPixels(var2, 0, var10 - var2, var3, var8, var6, 0, 0);
                    }

                    if (var3 < var12) {
                        var7.setPixels(0, var3, var10, var12 - var3, var8, var6, 0, 0);
                    }
                }
            } else {
                var1 = null;
        ...
        var11.setPixels(0, 0, var2, var3, var9, var6, var14, var15);
        return var1;
    }
    ...
    public static BufferedImage fromFXImage(Image var0, BufferedImage var1) {
        ...
        if (var2 == null) {
            ...
            var2.getPixels(0, 0, var3, var4, var10, var9, var7, var12);
            return var1;
        }
    }
